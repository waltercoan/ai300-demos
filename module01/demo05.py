...
mltable_path = os.path.join(os.path.dirname(__file__), "..", "data", "test-data")

# Nome e versão que o asset vai receber no workspace
data_name = "diabetes-test-mltable"
data_version = "1"
...
diabetes_data_asset = Data(
    ...
    description="Dataset test diabetes.csv carregado como MLTable",
    path=mltable_path,
